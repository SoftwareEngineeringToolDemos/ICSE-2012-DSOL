...
public class PlanningGraph implements GraphElement {
	...
	public PlanningGraph(ActionLevelGenerator actionLevelGenerator,	
						 PropositionLevelGenerator propositionLevelGenerator) {
		this.graphLevels = new ArrayList<GraphLevel>();
		this.actionLevelGenerator = actionLevelGenerator;
		this.propositionLevelGenerator = propositionLevelGenerator;
		//And the mutex generator
		this.mutexGenerator = new MutexGeneratorImpl();
	}

	public PlanningGraph(PropositionLevel initialState,
						 ActionLevelGenerator actionLevelGenerator,	
						 PropositionLevelGenerator propositionLevelGenerator) {
		this(actionLevelGenerator, propositionLevelGenerator);
