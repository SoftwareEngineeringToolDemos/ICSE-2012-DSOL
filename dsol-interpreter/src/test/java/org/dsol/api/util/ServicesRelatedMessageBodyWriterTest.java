...
public class ServicesRelatedMessageBodyWriterTest {
	...
	public void testWriteToServices() throws WebApplicationException, IOException{
		...
		Service serviceInfo = Service.createSoapService("id", "name", null,null,null,null,null, null);		
		Service serviceInfo2 = Service.createSoapService("id2", "name", null,null,null,null,null, null);
	...
	public void testWriteToSeveralServices() throws WebApplicationException, IOException{
		...
		Service serviceInfo = Service.createSoapService("id", "name", null,null,null,null,null, null);		
		Service serviceInfo2 = Service.createSoapService("id2", "name2", null,null,null,null,null, null);
